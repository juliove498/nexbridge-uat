      ...
      <div className="container">
        ...
        <section className="section">
          <div className="reveal mb-12">
            <h2 className="font-display text-[1.6rem] font-bold mb-2">{t('regulatoryProcess.title')}</h2>
            <p className="text-text-secondary text-[15px]">{t('regulatoryProcess.subtitle')}</p>
          </div>
          <div className="reveal grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
            {(['certified', 'registered', 'audited', 'supervised'] as const).map((key, i) => (
              <div
                key={key}
              ...
              >
                ...
                <h4 className="font-display text-lg font-bold mb-2.5">{t(`regulatoryProcess.steps.${key}.title`)}</h4>
                <p className="text-sm text-text-tertiary leading-relaxed">{t(`regulatoryProcess.steps.${key}.desc`)}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="section">
          <div className="reveal mb-12">
            <h2 className="font-display text-[1.6rem] font-bold mb-2">{t('authorizations.title')}</h2>
            <p className="text-text-secondary text-[15px]">{t('authorizations.subtitle')}</p>
          </div>
          <div className="reveal grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
            {(['issuer', 'dasp', 'vasp', 'lei'] as const).map((key) => (
              ...
              >
                ...
                <div className={`font-display text-[22px] font-bold text-orange mb-1.5 ${key === 'lei' ? 'text-[13px] break-all' : ''}`}>
                  {t(`authorizations.cards.${key}.value`)}
                </div>
                <div className="text-[13px] text-text-tertiary">{t(`authorizations.cards.${key}.source`)}</div>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="section">
          <div className="reveal mb-12">
            <h2 className="font-display text-[1.6rem] font-bold mb-2">{t('regulatoryBodies.title')}</h2>
            <p className="text-text-secondary text-[15px]">{t('regulatoryBodies.subtitle')}</p>
          </div>
          <div className="reveal grid grid-cols-1 md:grid-cols-3 gap-4">
            {(['cnad', 'cnv', 'lei'] as const).map((key) => (
              ...
              >
                ...
                <p className="text-sm text-text-secondary leading-[1.8]">{t(`regulatoryBodies.${key}.desc`)}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="section">
          <div className="reveal mb-12">
            <h2 className="font-display text-[1.6rem] font-bold mb-2">{t('compliance.title')}</h2>
            <p className="text-text-secondary text-[15px]">{t('compliance.subtitle')}</p>
          </div>
          <div className="reveal grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="flex gap-4 items-start bg-white/[0.02] border border-white/[0.06] rounded-lg py-7 px-6 transition-all duration-300 hover:border-orange/20 hover:-translate-y-0.5 hover:shadow-[0_12px_40px_rgba(0,0,0,0.2)]">
              ...
              <div>
                <h4 className="font-display text-[15px] font-bold mb-1.5 text-text-primary">{t('compliance.features.kycAml.title')}</h4>
                <p className="text-[13px] text-text-secondary leading-relaxed">{t('compliance.features.kycAml.desc')}</p>
              </div>
            </div>
            ...
            <div className="flex gap-4 items-start bg-white/[0.02] border border-white/[0.06] rounded-lg py-7 px-6 transition-all duration-300 hover:border-orange/20 hover:-translate-y-0.5 hover:shadow-[0_12px_40px_rgba(0,0,0,0.2)]">
              ...
              <div>
                <h4 className="font-display text-[15px] font-bold mb-1.5 text-text-primary">{t('compliance.features.proofOfReserves.title')}</h4>
                <p className="text-[13px] text-text-secondary leading-relaxed">{t('compliance.features.proofOfReserves.desc')}</p>
              </div>
            </div>
            ...
            <div className="flex gap-4 items-start bg-white/[0.02] border border-white/[0.06] rounded-lg py-7 px-6 transition-all duration-300 hover:border-orange/20 hover:-translate-y-0.5 hover:shadow-[0_12px_40px_rgba(0,0,0,0.2)]">
              ...
              <div>
                <h4 className="font-display text-[15px] font-bold mb-1.5 text-text-primary">{t('compliance.features.investorProtection.title')}</h4>
                <p className="text-[13px] text-text-secondary leading-relaxed">{t('compliance.features.investorProtection.desc')}</p>
              </div>
            </div>
            ...
            <div className="flex gap-4 items-start bg-white/[0.02] border border-white/[0.06] rounded-lg py-7 px-6 transition-all duration-300 hover:border-orange/20 hover:-translate-y-0.5 hover:shadow-[0_12px_40px_rgba(0,0,0,0.2)]">
              ...
              <div>
                <h4 className="font-display text-[15px] font-bold mb-1.5 text-text-primary">{t('compliance.features.dailyNav.title')}</h4>
                <p className="text-[13px] text-text-secondary leading-relaxed">{t('compliance.features.dailyNav.desc')}</p>
              </div>
            </div>
            ...
            <div className="flex gap-4 items-start bg-white/[0.02] border border-white/[0.06] rounded-lg py-7 px-6 transition-all duration-300 hover:border-orange/20 hover:-translate-y-0.5 hover:shadow-[0_12px_40px_rgba(0,0,0,0.2)]">
              ...
              <div>
                <h4 className="font-display text-[15px] font-bold mb-1.5 text-text-primary">{t('compliance.features.transparentReporting.title')}</h4>
                <p className="text-[13px] text-text-secondary leading-relaxed">{t('compliance.features.transparentReporting.desc')}</p>
              </div>
            </div>
            ...
            <div className="flex gap-4 items-start bg-white/[0.02] border border-white/[0.06] rounded-lg py-7 px-6 transition-all duration-300 hover:border-orange/20 hover:-translate-y-0.5 hover:shadow-[0_12px_40px_rgba(0,0,0,0.2)]">
              ...
              <div>
                <h4 className="font-display text-[15px] font-bold mb-1.5 text-text-primary">{t('compliance.features.serialIssuer.title')}</h4>
                <p className="text-[13px] text-text-secondary leading-relaxed">{t('compliance.features.serialIssuer.desc')}</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="section">
          <div className="reveal relative overflow-hidden text-center py-10 px-6 sm:py-15 sm:px-10 max-w-200 mx-auto bg-white/[0.02] border border-white/[0.06] rounded-xl before:content-[''] before:absolute before:inset-0 before:bg-[radial-gradient(ellipse_60%_60%_at_50%_50%,rgba(232,100,44,0.04),transparent)] before:pointer-events-none">
            <h3 className="font-display text-[1.4rem] font-bold mb-4 relative">{t('lookingAhead.title')}</h3>
            <p className="text-[15px] text-text-secondary leading-[1.8] max-w-150 mx-auto relative">{t('lookingAhead.desc')}</p>
          </div>
        </section>
      </div>
    </main>
